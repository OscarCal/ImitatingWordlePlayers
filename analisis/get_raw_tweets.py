...
def batch1():
    ini_date = date(2022,1,1)
    for game in range(196, 277):
        tweets_list2 = []
...
def batch2():
    ini_date = date(2022,3,23)
    for game in range(277, 358):
        tweets_list2 = []
        for trials in range(1,7):
            for i,tweet in enumerate(sntwitter.TwitterSearchScraper('"Wordle '+str(game)+' '+str(trials)+'/6"'
                                                                    +' lang:en since:'+str(ini_date)
...
def batch3():
    ini_date = date(2022,6,12)
    for game in range(358, 439):
        tweets_list2 = []
        for trials in range(1,7):
            for i,tweet in enumerate(sntwitter.TwitterSearchScraper('"Wordle '+str(game)+' '+str(trials)+'/6"'
                                                                    +' lang:en since:'+str(ini_date)
...
def batch4():
    ini_date = date(2022,9,1)
    for game in range(439, 516):
        tweets_list2 = []
        for trials in range(1,7):
            for i,tweet in enumerate(sntwitter.TwitterSearchScraper('"Wordle '+str(game)+' '+str(trials)+'/6"'
                                                                    +' lang:en since:'+str(ini_date)
